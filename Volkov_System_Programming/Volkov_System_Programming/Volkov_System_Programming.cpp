...
#include "framework.h"
#include "Volkov_System_Programming.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_VOLKOVSYSTEMPROGRAMMING, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_VOLKOVSYSTEMPROGRAMMING));
...
ATOM MyRegisterClass(HINSTANCE hInstance) // эта функция возвращает значение идентифицирующее зарегистрированный класс окна
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_VOLKOVSYSTEMPROGRAMMING));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_VOLKOVSYSTEMPROGRAMMING);
